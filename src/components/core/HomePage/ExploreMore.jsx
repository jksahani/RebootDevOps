    ...
    <div>
      ...
      {/* Heading text */}
        <div className='text-4xl font-semibold text-center '>
            Learn What <HighLightText text={" Matters"} />
        </div>
      ...
      {/*Tabs div */}
        <div className=' hidden lg:flex mt-5 shadow-custom  flex-row rounded-full
         bg-richblack-800 mb-5 border-richblack-100 p-1'>
            {
                tabsName.map( (element, index) => {
                    return (
                        <div

                            className={`text-[16px] flex flex-row items-center font-medium 
                            ${
                                currentTab === element 
        ...
        flex-wrap w-full lg:left-1 lg:-translate-y-[50%] text-black lg:mb-0  mb-9 lg:px-0 px-3'>
